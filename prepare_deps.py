...
def prepare_caffe(args):
    ...
    ret = os.system(
        '{} .. -DALLOW_LMDB_NOLOCK=ON -DCMAKE_INSTALL_PREFIX=../install -DCMAKE_BUILD_TYPE=Release -DCUDA_ARCH_NAME=Manual -DCUDA_ARCH_BIN="50 60 61" -DCUDNN_ROOT="{}" -DCUDNN_INCLUDE="{}" -DCUDNN_LIBRARY="{}"'.format(
